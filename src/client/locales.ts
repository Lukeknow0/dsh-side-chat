...
export type SideChatLocaleKey =
  ...
  | 'drawer.contextNote' | 'drawer.error' | 'drawer.shortcut'
...
export const en: Record<SideChatLocaleKey, string> = {
  ...
  'drawer.close': 'Close Side Chat', 'drawer.discard': 'Discarded when closed', 'drawer.you': 'You',
  ...
  'drawer.error': 'Side Chat could not open', 'drawer.shortcut': '⌘⇧.',
}
...
export const zh: Record<SideChatLocaleKey, string> = {
  ...
  'drawer.close': '关闭侧边对话', 'drawer.discard': '关闭后丢弃', 'drawer.you': '你',
  'drawer.assistant': '侧边助手', 'drawer.reading': '正在查看上下文…',
  'drawer.contextNote': '继承内容仅作参考，主会话不会被写入这段追问。',
  'drawer.error': '侧边对话无法打开', 'drawer.shortcut': '⌘⇧.',
}
